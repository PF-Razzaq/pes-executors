...
import { Delete, Edit, Print, HourglassEmpty } from "@mui/icons-material";
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}/api/after_care_page360/${LocationID}`
      );
...
export default AftercareList365;
